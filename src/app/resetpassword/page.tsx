...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-800">
      ...
      <h1 className="text-gray-900 bg-gray-300 px-10 py-2 rounded-tl-3xl  rounded-br-3xl rounded-bl-md rounded-tr-md font-serif font-bold tracking-wider mb-5 outline outline-offset-2">Reset Password</h1>
      <input
        type="password"
      ...
      <button
        ...
        disabled={loading}
        className={`bg-gray-700 rounded-lg p-2 cursor-pointer ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
      >
